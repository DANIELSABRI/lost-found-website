...
<nav class="top-nav">
    ...
    <div class="nav-links">
        ...
        <a href="<?= BASE_URL ?>/user/report-lost.php" class="active">Report Lost</a>
    ...
    <div class="dashboard-layout">
        ...
        <main>
            <div class="page-intro" style="text-align: left; margin: 0 0 30px 0;">
                <h1>Intelligence Report: <span style="color: var(--color-primary);">Lost Item</span></h1>
                <p>Your precision helps our network detect and recover your property. Provide high-fidelity details below.</p>
            </div>
            ...
            <div class="glass-card" style="margin: 0;">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; margin-bottom: 40px;">
                        <section>
                            <h3 style="font-size: 18px; font-weight: 800; margin-bottom: 25px; color: var(--color-text-main); display: flex; align-items: center; gap: 10px;">
                                <span style="width: 32px; height: 32px; background: var(--color-primary-light); color: var(--color-primary); display: flex; align-items: center; justify-content: center; border-radius: 8px; font-size: 14px;">1</span>
                                Identification Details
                            </h3>
                            
                            <div class="form-group">
                                <label>Item Display Name *</label>
                                <input type="text" name="item_name" class="form-control" placeholder="e.g. Silver iPhone 15 Pro" required>
                            </div>
                        ...
                        <section>
                            <h3 style="font-size: 18px; font-weight: 800; margin-bottom: 25px; color: var(--color-text-main); display: flex; align-items: center; gap: 10px;">
                                <span style="width: 32px; height: 32px; background: var(--color-primary-light); color: var(--color-primary); display: flex; align-items: center; justify-content: center; border-radius: 8px; font-size: 14px;">2</span>
                                Event Parameters
                            </h3>

                            <div class="form-group">
                                <label>Deployment Location *</label>
                                <input type="text" name="location" class="form-control" placeholder="e.g. Science Lab B2" required>
                            </div>

                            <div class="form-group">
                                <label>Point of Incident Date *</label>
                    ...
                    <div style="border-top: 1px solid rgba(0,0,0,0.05); padding-top: 40px; margin-bottom: 40px;">
                        <h3 style="font-size: 18px; font-weight: 800; margin-bottom: 25px; color: var(--color-text-main); display: flex; align-items: center; gap: 10px;">
                            <span style="width: 32px; height: 32px; background: var(--color-primary-light); color: var(--color-primary); display: flex; align-items: center; justify-content: center; border-radius: 8px; font-size: 14px;">3</span>
                            Visual Assets & Intelligence
                        </h3>

                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px;">
                            <div class="form-group">
                                <label>Tactical Description *</label>
                                <textarea name="description" class="form-control" style="min-height: 180px;" placeholder="Mention unique marks, stickers, or specific case colors..." required></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="image-upload-box" style="height: 180px; display: flex; flex-direction: column; align-items: center; justify-content: center;" onclick="document.getElementById('item-img').click()">
                                    <div id="upload-placeholder">
                                        ...
                                        <p style="margin-top: 10px; font-weight: 800; font-size: 14px;">Upload Captured Image</p>
                    ...
                    <button type="submit" class="btn-primary" style="width: 100%; border-radius: var(--radius-xl); padding: 22px;">Broadcast Loss Intelligence</button>
                </form>
            </div>
        </main>
        ...
        <aside>
            ...
            <div class="glass-card" style="padding: 30px; text-align: center;">
                ...
                <h5 style="margin-top: 15px; font-weight: 800;">Filing Tips</h5>
                <p style="font-size: 12px; color: var(--color-text-muted); margin-top: 8px;">Be precise. Vague reports reduce recovery probability by 40%.</p>
            </div>
        </aside>
    </div>
</div>
