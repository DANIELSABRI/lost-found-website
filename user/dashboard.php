...
<style>
    ...
    .pulse-footer, .btn-relay { position: relative; z-index: 2; }
</style>
</head>
<body>
                    ...
                    <?php foreach ($pulseItems as $item): ?>
                        <div class="pulse-card">
                            ...
                            <div class="pulse-meta">
                                <h4><a href="../item.php?id=<?= $item['id'] ?>" class="stretched-link" style="color:inherit; text-decoration:none;"><?= htmlspecialchars($item['item_name']) ?></a></h4>
